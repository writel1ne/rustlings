...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        .and_modify(|score| {score.goals_scored += team_1_score; score.goals_conceded += team_2_score})
        .or_insert(Team{ goals_scored: team_1_score, goals_conceded: team_2_score});

        let team2 = scores.entry(team_2_name)
        .and_modify(|score| {score.goals_scored += team_2_score; score.goals_conceded += team_1_score})
